...
from sage_is_ai.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from sage_is_ai.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
...
from sage_is_ai.utils.misc import parse_duration
from sage_is_ai.utils.auth import get_password_hash, create_token
...
class OAuthManager:
    ...
    async def _process_picture_url(
        ...
        Returns:
            A data URL containing the base64 encoded picture, or "/static/user.png" if processing fails
        """
        if not picture_url:
