...
def replace_imports(content):
    ...
    """
    replacements = {
        # Legacy bare imports (from original Open WebUI)
        "from utils": "from sage_is_ai.utils",
        "from apps": "from sage_is_ai.apps",
        "from main": "from sage_is_ai.main",
        "from config": "from sage_is_ai.config",
        # Compat: tools written for open_webui still work
        "from open_webui.": "from sage_is_ai.",
        "import open_webui.": "import sage_is_ai.",
    }
