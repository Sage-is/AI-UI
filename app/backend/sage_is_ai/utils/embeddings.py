...
from sage_is_ai.routers.openai import embeddings as openai_embeddings
...
from sage_is_ai.utils.payload import convert_embedding_payload_openai_to_ollama
from sage_is_ai.utils.response import convert_embedding_response_ollama_to_openai
...
async def generate_embeddings(
    ...
    Returns:
        dict: The embeddings response, following OpenAI Compatible API compatibility.
    """
