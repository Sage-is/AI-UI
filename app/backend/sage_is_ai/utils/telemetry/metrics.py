"""OpenTelemetry metrics bootstrap for Sage.is AI.
...
`/metrics` endpoint – AI-UI does **not** expose it directly.
...
from sage_is_ai.env import OTEL_SERVICE_NAME, OTEL_EXPORTER_OTLP_ENDPOINT

from sage_is_ai.socket.main import get_active_user_ids
