from sage_is_ai.utils.task import prompt_template, prompt_variables_template
...
def convert_payload_openai_to_ollama(openai_payload: dict) -> dict:
    ...
    Args:
        openai_payload (dict): The payload originally designed for OpenAI Compatible API usage.
...
def convert_embedding_payload_openai_to_ollama(openai_payload: dict) -> dict:
    ...
    Args:
        openai_payload (dict): The original payload designed for OpenAI Compatible API usage.
