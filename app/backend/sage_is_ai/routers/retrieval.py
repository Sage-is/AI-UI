...
from sage_is_ai.retrieval.utils import (
...
def get_rf(
    ...
    if reranking_model:
        if any(model in reranking_model for model in ["jinaai/jina-colbert-v2"]):
            try:
                from sage_is_ai.retrieval.models.colbert import ColBERT
            ...
            if engine == "external":
                try:
                    from sage_is_ai.retrieval.models.external import ExternalReranker
