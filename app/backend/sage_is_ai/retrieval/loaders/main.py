...
from sage_is_ai.retrieval.loaders.mistral import MistralLoader
from sage_is_ai.retrieval.loaders.datalab_marker import DatalabMarkerLoader
...
class TikaLoader:
    ...
    def load(self) -> list[Document]:
        ...
        if self.extract_images == True:  # noqa: E712
