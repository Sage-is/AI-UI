...
from sage_is_ai.bridges.types import PlatformInfo
...
class BridgeManager:
    ...
    def get_available_platforms() -> list[dict]:
        ...
        if not PLATFORM_ADAPTERS:
            try:
                import sage_is_ai.bridges.adapters.whatsapp  # noqa: F401
            except ImportError:
                pass
            try:
                import sage_is_ai.bridges.adapters.email  # noqa: F401
            except ImportError:
                pass
            try:
                import sage_is_ai.bridges.adapters.telegram  # noqa: F401
            except ImportError:
                pass
            try:
                import sage_is_ai.bridges.adapters.signal  # noqa: F401
            except ImportError:
                pass
        platforms = []
