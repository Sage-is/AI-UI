		...
		{#if config}
			<div>
				<div style="--mb:0.8rem">
					...
					<div style="--mb:0.625rem">
						<div style="--d:flex; --w:100%; --jc:space-between">
							<div style="--as:center; --size:0.6rem; --weight:500">{$i18n.t('Code Execution Engine')}</div>
						...
						{#if config.CODE_EXECUTION_ENGINE === 'jupyter'}
							<div style="--c:var(--color-gray-500); --size:0.6rem">
								{$i18n.t(
					...
					{#if config.CODE_EXECUTION_ENGINE === 'jupyter'}
						<div style="--mb:0.625rem; --d:flex; --fd:column; --g:0.4rem; --w:100%">
							...
							<div style="--d:flex; --w:100%">
								<div style="--fx:1 1 0%">
									<input
										style="--w:100%; --size:0.8rem; --py:0.125rem; --bgc:transparent; --oe:none"
	class="placeholder:text-gray-300 dark:placeholder:text-gray-700"
						...
						<div style="--mb:0.625rem; --d:flex; --fd:column; --g:0.4rem; --w:100%">
							<div style="--d:flex; --g:0.5rem; --w:100%; --ai:center; --jc:space-between">
								...
								<div>
									<select
										style="--dark-bgc:var(--color-gray-900); --w:fit-content; --pr:2rem; --radius:0.125rem; --px:0.5rem; --p:0.2rem; --size:0.6rem; --bgc:transparent; --oe:none; --ta:left"
						...
						<div style="--d:flex; --g:0.5rem; --w:100%; --ai:center; --jc:space-between">
							...
							<div class="">
								<Tooltip content={$i18n.t('Enter timeout in seconds')}>
									<input
										style="--dark-bgc:var(--color-gray-900); --w:fit-content; --radius:0.125rem; --px:0.5rem; --p:0.2rem; --size:0.6rem; --bgc:transparent; --oe:none; --ta:right"
										type="number"
	...
	class="placeholder:text-gray-300 dark:placeholder:text-gray-700"
						...
						<div>
							<div style="--py:0.125rem; --w:100%">
								<div style="--mb:0.625rem; --size:0.6rem; --weight:500">
