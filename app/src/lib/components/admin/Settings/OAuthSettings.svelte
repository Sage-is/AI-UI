	...
	<div style="--d:flex; --fd:column; --g:0.8rem">
		...
		>
			...
			>
				<div style="--d:flex; --ai:center; --g:0.5rem">
					<!-- Google icon -->
					<BrandIcon name="github-oauth" className="size-4" />
				...
				<!-- Chevron indicator -->
				<Icon name="chevron-down-fill-16" className="size-[0.8rem]" />
			</summary>
		...
		>
			...
			>
				<div style="--d:flex; --ai:center; --g:0.5rem">
					<!-- GitHub icon -->
					<Icon name="github-fill-16" className="size-4" />
		...
		>
			...
			>
				<div style="--d:flex; --ai:center; --g:0.5rem">
					<!-- Email icon -->
					<Icon name="mail-fill-16" className="size-4" />
		...
		>
			...
			>
				<div style="--d:flex; --ai:center; --g:0.5rem">
					<!-- Sage icon -->
					<Icon name="oidc-fill-16" className="size-4" />
