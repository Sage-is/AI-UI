...
<div
	style="--d:flex; --ai:flex-start; --bgc:#F1F8FE; --dark-bgc:#020C1D;  --bc:3371D5; --dark-bc:#03113B; --size:#2B6CD4; --dark-size:#6795EC; --radius:0.5rem; --px:0.875rem; --py:0.6rem; --size:0.6rem; --maxw:20rem; --pr:0.5rem; --w:100%; --shadow:4"
>
