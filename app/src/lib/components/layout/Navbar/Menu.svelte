...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			style="--w:100%; --maxw:200px; --radius:0.75rem; --px:0.25rem; --py:0.375rem; --z:50; --bgc:#fff; --dark-bgc:var(--color-gray-850); --dark-c:#fff; --shadow:4"
			sideOffset={8}
			side="bottom"
			align="end"
		...
		>
			<!-- <DropdownMenu.Item
				style="--d:flex; --g:0.5rem; --ai:center; --px:0.75rem; --py:0.5rem; --size:0.875rem; --cur:pointer; --hvr-dark-bgc:var(--color-gray-800); --radius:0.375rem"
				on:click={async () => {
			...
			{#if $mobile}
				<DropdownMenu.Item
					style="--d:flex; --g:0.5rem; --ai:center; --px:0.75rem; --py:0.5rem; --size:0.875rem; --cur:pointer; --hvr-bgc:var(--color-gray-50); --hvr-dark-bgc:var(--color-gray-800); --radius:0.375rem; --us:none; --w:100%"
