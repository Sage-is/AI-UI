...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			style="--w:100%; --maxw:11rem; --radius:0.6rem; --p:0.25rem; --z:50; --bgc:#fff; --dark-bgc:var(--color-gray-850); --dark-c:#fff; --shadow:1"
			sideOffset={4}
			side="bottom"
			align="end"
